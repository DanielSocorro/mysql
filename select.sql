...
SELECT year(birthdate) FROM clients;  --- functions 
+-----------------+
| year(birthdate) |
+-----------------+
|            1971 |
...
+---------------------+--------------------------------+
| Maria Dolores Gomez |                             51 |
| Adrian Fernandez    |                             52 |
| Maria Luisa Marin   |                             65 |
| Pedro Sanchez       |                             30 |
| Pablo Saavedra      |                             62 |
| Marta Carrillo      |                             41 |
| Javier Barrio       |                             51 |
...
+-------------------+------------------------------------+--------------------------------+--------+
| Juana Maria Lopez | Juana Maria.51072683X@random.names |                             32 | F      |
| Carmen Lopez      | Carmen.09399409E@random.names      |                             35 | F      |
+-------------------+------------------------------------+--------------------------------+--------+
